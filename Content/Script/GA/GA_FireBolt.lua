...
function M:K2_ActivateAbility()
    ...
    local Proxy = UE.UAbilityTask_PlayMontageAndWait.CreatePlayMontageAndWaitProxy(
        self, nil, self.FireAnim, 1, nil, true, 1.0, 0)
    Proxy:ReadyForActivation()

    -- local P = UE.UAbilityTask_WaitGameplayEvent.WaitGameplayEvent(self,self.WaitTag,nil,false,true)

    UE.UKismetSystemLibrary.PrintString(WorldContectObject,"测试GA开始ActivateTest")
end
-- eg
-- function M:K2_ActivateAbility()
