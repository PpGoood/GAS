...
FClassRegistrationInfo Z_Registration_Info_UClass_UUnLuaEditorFunctionLibrary;
UClass* UUnLuaEditorFunctionLibrary::GetPrivateStaticClass()
{
	using TClass = UUnLuaEditorFunctionLibrary;
	if (!Z_Registration_Info_UClass_UUnLuaEditorFunctionLibrary.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("UnLuaEditorFunctionLibrary"),
			Z_Registration_Info_UClass_UUnLuaEditorFunctionLibrary.InnerSingleton,
			StaticRegisterNativesUUnLuaEditorFunctionLibrary,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UUnLuaEditorFunctionLibrary.InnerSingleton;
}
UClass* Z_Construct_UClass_UUnLuaEditorFunctionLibrary_NoRegister()
{
	return UUnLuaEditorFunctionLibrary::GetPrivateStaticClass();
}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_GAS_Plugins_UnLua_Source_UnLuaEditor_Private_UnLuaEditorFunctionLibrary_h__Script_UnLuaEditor_Statics
{
...
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_GAS_Plugins_UnLua_Source_UnLuaEditor_Private_UnLuaEditorFunctionLibrary_h__Script_UnLuaEditor_222330765(TEXT("/Script/UnLuaEditor"),
	Z_CompiledInDeferFile_FID_GAS_Plugins_UnLua_Source_UnLuaEditor_Private_UnLuaEditorFunctionLibrary_h__Script_UnLuaEditor_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_GAS_Plugins_UnLua_Source_UnLuaEditor_Private_UnLuaEditorFunctionLibrary_h__Script_UnLuaEditor_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
