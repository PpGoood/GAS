...
FClassRegistrationInfo Z_Registration_Info_UClass_UUnLuaEditorSettings;
UClass* UUnLuaEditorSettings::GetPrivateStaticClass()
{
	using TClass = UUnLuaEditorSettings;
	if (!Z_Registration_Info_UClass_UUnLuaEditorSettings.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("UnLuaEditorSettings"),
			Z_Registration_Info_UClass_UUnLuaEditorSettings.InnerSingleton,
			StaticRegisterNativesUUnLuaEditorSettings,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UUnLuaEditorSettings.InnerSingleton;
}
UClass* Z_Construct_UClass_UUnLuaEditorSettings_NoRegister()
{
	return UUnLuaEditorSettings::GetPrivateStaticClass();
}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_GAS_Plugins_UnLua_Source_UnLuaEditor_Private_UnLuaEditorSettings_h__Script_UnLuaEditor_Statics
{
...
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_GAS_Plugins_UnLua_Source_UnLuaEditor_Private_UnLuaEditorSettings_h__Script_UnLuaEditor_2427539056(TEXT("/Script/UnLuaEditor"),
	Z_CompiledInDeferFile_FID_GAS_Plugins_UnLua_Source_UnLuaEditor_Private_UnLuaEditorSettings_h__Script_UnLuaEditor_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_GAS_Plugins_UnLua_Source_UnLuaEditor_Private_UnLuaEditorSettings_h__Script_UnLuaEditor_Statics::ClassInfo),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_GAS_Plugins_UnLua_Source_UnLuaEditor_Private_UnLuaEditorSettings_h__Script_UnLuaEditor_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_GAS_Plugins_UnLua_Source_UnLuaEditor_Private_UnLuaEditorSettings_h__Script_UnLuaEditor_Statics::EnumInfo));
// ********** End Registration *********************************************************************
