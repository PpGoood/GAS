...
#include "ListenCooldownChangeTask.generated.h"
...
class GAS_API UListenCooldownChangeTask : public UBlueprintAsyncActionBase
{
	GENERATED_BODY()
...
public:
	...
	static UListenCooldownChangeTask* ListenForCooldownChange(UAbilitySystemComponent* AbilitySystemComponent, const FGameplayTag& InCooldownTag);
